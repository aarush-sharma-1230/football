  ...
  return (
    <div className="padding-medium">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Aarush
        Sharma. Aarush Sharma is committed to ensuring that the app is as useful
        ...
        Everything about Football app stores and processes personal data that
        you have provided to us, to provide my Service. It’s your responsibility
        ...
        features and it could mean that the Everything about Football app won’t
        work properly or at all. You should be aware that there are certain
        things that Aarush Sharma will not take responsibility for. Certain
        ...
        network provider, but Aarush Sharma cannot take responsibility for the
        app not working at full functionality if you don’t have access to Wi-Fi,
        and you don’t have any of your data allowance left. If you’re using the
        app outside of an area with Wi-Fi, you should remember that the terms of
        the agreement with your mobile network provider will still apply. As a
        result, you may be charged by your mobile provider for the cost of data
        ...
        same lines, Aarush Sharma cannot always take responsibility for the way
        ...
        the Service, Aarush Sharma cannot accept responsibility. With respect to
        Aarush Sharma’s responsibility for your use of the app, when you’re
        using the app, it’s important to bear in mind that although we endeavor
        to ensure that it is updated and correct at all times, we do rely on
        third parties to provide information to us so that we can make it
        available to you. Aarush Sharma accepts no liability for any loss,
        ...
        to keep using the app. Aarush Sharma does not promise that it will
        always update the app so that it is relevant to you and/or works with
        the version that you have installed on your device. However, you promise
