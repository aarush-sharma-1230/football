...
const PrivacyPolicy = () => {
  return (
    <div className="padding-medium">
      ...
      <p>
        Aarush Sharma built the Everything about Football app as a Free app.
        This SERVICE is provided by Aarush Sharma at no cost and is intended for
        use as is. This page is used to inform visitors regarding my policies
        with the collection, use, and disclosure of Personal Information if
        anyone decided to use my Service. If you choose to use my Service, then
        ...
        Conditions, which are accessible at Everything about Football unless
